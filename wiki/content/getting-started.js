...
java -cp "target/classes;target/dependency/*" AshcoreQuickStart`)+ '<p>On Linux or macOS, use a colon in the classpath:</p>'+code('bash','Linux / macOS',`java -cp "target/classes:target/dependency/*" AshcoreQuickStart`)+code('text','Expected output',`distance=2.0, hitX=0.0
